import { getInfo } from "../api/getInfo/getinfo.mjs";
import { verificarContacto } from "../api/verificarContacto/verificarContacto.mjs";
import { login } from "../auth/login.mjs";
import { CustomError } from "../class/customError.mjs";
export const habeasData = async ({ body }) => {
    try {
